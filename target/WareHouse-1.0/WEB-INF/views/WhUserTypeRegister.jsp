...
<body>
<h1>WhUser Type Register page</h1>
<form:form action="insert" method="post" modelAttribute="whu">
<pre>
UserCode   :<form:radiobutton path="forType" value="vendor"/>VENDOE
            <form:radiobutton path="forType" value="customer"/>CUSTOMER
UserCode   :<form:input path="code"/>
UserFor    :<form:input path="type"/>
