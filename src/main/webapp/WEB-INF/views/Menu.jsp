      ...
      <a class="nav-link" href="#">Link 2</a>
		...
		<li class="nav-item dropdown"><a class="nav-link dropdown-toggle"
			...
			<div class="dropdown-menu">
				<a class="dropdown-item" href="${url}/uom/show">Register </a> <a
		...
		<li class="nav-item dropdown"><a class="nav-link dropdown-toggle"
			...
			<div class="dropdown-menu">
				<a class="dropdown-item" href="${url}/shipmenttype/show">Register </a>
		...
		<li class="nav-item dropdown"><a class="nav-link dropdown-toggle"
			...
			<div class="dropdown-menu">
				<a class="dropdown-item" href="${url}/item/show">Register </a>
